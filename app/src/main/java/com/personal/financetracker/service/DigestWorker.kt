...
class DigestWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        val totalSpent = todayTxns.filter { it.type == com.personal.financetracker.data.local.entity.TransactionType.EXPENSE }
            .sumOf { it.amount }
        val totalReceived = todayTxns.filter { it.type == com.personal.financetracker.data.local.entity.TransactionType.INCOME }
            .sumOf { it.amount }
